...
For standalone engine, the ProtonJ2SE artifact build will also include a .zip distribution, with ProtonJ2SE executable jar, launch script, sample and docs directory. 
