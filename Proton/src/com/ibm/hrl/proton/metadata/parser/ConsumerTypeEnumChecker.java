...
public class ConsumerTypeEnumChecker extends NullCheckAndEnum<ConsumerType> {

	public ConsumerTypeEnumChecker(String key, JSONObject jsonObject, String name,
	...
	@Override
	protected ConsumerType getEnumInner(String value) throws IllegalArgumentException {
		return ConsumerType.valueOf(value);
	}
