...
class ConsumptionPolicyEnumCheck extends NullCheckAndEnum<ConsumptionPolicyEnum> {

	public ConsumptionPolicyEnumCheck(String key, JSONObject jsonObject, String name,
	...
	@Override
	protected ConsumptionPolicyEnum getEnumInner(String value) throws IllegalArgumentException {
		return ConsumptionPolicyEnum.valueOf(value);
	}
