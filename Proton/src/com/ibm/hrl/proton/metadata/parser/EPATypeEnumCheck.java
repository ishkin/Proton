...
public class EPATypeEnumCheck extends NullCheckAndEnum<EPATypeEnum> {

	public EPATypeEnumCheck(String key, JSONObject jsonObject, String name,
	...
	@Override
	protected EPATypeEnum getEnumInner(String value) throws IllegalArgumentException {
		return EPATypeEnum.valueOf(value);
	}
