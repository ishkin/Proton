class cep::config {
	...
	file_line { '/usr/share/tomcat7/bin/setenv.sh_CATALINA_OPTS':
		...
		match   => '^CATALINA_OPTS=',
		line    => 'CATALINA_OPTS="-Dcom.sun.management.jmxremote -Dcom.sun.management.jmxremote.port=8686 -Dcom.sun.management.jmxremote.ssl=false -Dcom.sun.management.jmxremote.authenticate=false"   #For less secure, add:# -Djava.security.egd=file:/dev/./urandom',
		ensure  => present,
