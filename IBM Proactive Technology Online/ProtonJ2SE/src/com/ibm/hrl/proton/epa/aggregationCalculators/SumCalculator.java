...
public class SumCalculator extends AggregationCalculator {
	public SumCalculator(AggregationSchema schema, String variableName) {
	...
	public double getResult() {
		double sum = 0;
		for (int i = 0; i < operandsArrays.length; i++) {
