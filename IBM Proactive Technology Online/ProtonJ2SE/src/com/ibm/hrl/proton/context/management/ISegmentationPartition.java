...
/**
 * Interface for segmentation partition (used for both global and local segmentation).
 * <code>ISegmentationPartition</code>.
 * 
 */
public interface ISegmentationPartition {
