...
public class OrderPolicyEnumCheck extends NullCheckAndEnum<OrderPolicyEnum> {

	public OrderPolicyEnumCheck(String key, JSONObject jsonObject, String name,
	...
	@Override
	protected OrderPolicyEnum getEnumInner(String value) throws IllegalArgumentException {
		return OrderPolicyEnum.valueOf(value);
	}
