...
public class EvaluationPolicyEnumCheck extends NullCheckAndEnum<EvaluationPolicyEnum> {

	public EvaluationPolicyEnumCheck(String key, JSONObject jsonObject, String name,
	...
	@Override
	protected EvaluationPolicyEnum getEnumInner(String value) throws IllegalArgumentException {
		return EvaluationPolicyEnum.valueOf(value);
	}
