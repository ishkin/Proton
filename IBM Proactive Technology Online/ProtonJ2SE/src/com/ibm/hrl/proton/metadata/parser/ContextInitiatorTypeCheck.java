...
class ContextInitiatorTypeCheck extends NullCheckAndEnum<ContextInitiatorType> {


	public ContextInitiatorTypeCheck(String key, JSONObject jsonObject, String name,
	...
	@Override
	protected ContextInitiatorType getEnumInner(String value) throws IllegalArgumentException {
		return ContextInitiatorType.valueOf(value);
	}
}
