...
class ContextInitiatorPolicyEnumChecker extends NullCheckAndEnum<ContextInitiatorPolicyEnum> {

	public ContextInitiatorPolicyEnumChecker(String key, JSONObject jsonObject, String name,
	...
	@Override
	protected ContextInitiatorPolicyEnum getEnumInner(String value) throws IllegalArgumentException {
		return ContextInitiatorPolicyEnum.valueOf(value);
	}
