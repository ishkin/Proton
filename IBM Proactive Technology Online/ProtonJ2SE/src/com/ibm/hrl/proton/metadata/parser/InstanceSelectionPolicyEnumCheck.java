...
public class InstanceSelectionPolicyEnumCheck extends NullCheckAndEnum<InstanceSelectionPolicyEnum> {

	public InstanceSelectionPolicyEnumCheck(String key, JSONObject jsonObject, String name,
	...
	@Override
	protected InstanceSelectionPolicyEnum getEnumInner(String value) throws IllegalArgumentException {
		return InstanceSelectionPolicyEnum.valueOf(value);
	}
