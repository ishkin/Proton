...
class ContextTerminatorPolicyChecker extends NullCheckAndEnum<ContextTerminatorPolicyEnum> {
	public ContextTerminatorPolicyChecker(String key, JSONObject jsonObject, String name,
	...
	@Override
	protected ContextTerminatorPolicyEnum getEnumInner(String value) throws IllegalArgumentException {
		return ContextTerminatorPolicyEnum.valueOf(value);
	}
}
