...
public class ProducerTypeEnumChecker extends NullCheckAndEnum<ProducerType> {
	public ProducerTypeEnumChecker(String key, JSONObject jsonObject, String name,
	...
	@Override
	protected ProducerType getEnumInner(String value) throws IllegalArgumentException {
		return ProducerType.valueOf(value);
	}
}
