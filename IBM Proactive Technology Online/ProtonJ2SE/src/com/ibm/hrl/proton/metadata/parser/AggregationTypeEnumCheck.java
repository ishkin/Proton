...
public class AggregationTypeEnumCheck extends NullCheckAndEnum<AggregationTypeEnum> {

	public AggregationTypeEnumCheck(String key, JSONObject jsonObject, String name,
	...
	@Override
	protected AggregationTypeEnum getEnumInner(String value) throws IllegalArgumentException {
		return AggregationTypeEnum.valueOf(value);
	}
