...
class ContextTypeEnumsChecker extends NullCheckAndEnum<ContextTypeEnum> {

	public ContextTypeEnumsChecker(String key, JSONObject jsonObject, String name,
	...
	@Override
	protected ContextTypeEnum getEnumInner(String value) {
		return ContextTypeEnum.valueOf(value);
	}	
}
