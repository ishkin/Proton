...
public class FileTimedInputAdapter extends AbstractInputTimedAdapter {
	...
	public FileTimedInputAdapter(ProducerMetadata producerMetadata,
			IInputConnector serverConnector,EventMetadataFacade eventMetadata,EepFacade eep) throws AdapterException {
	...
	public IEventInstance readData() throws AdapterException {
		...
		try {
			...
			if( fileLength > filePointer ) 
			{
				...
				//we assume here detection time is part of the input and is set accordingly by the parser
	...
	public IInputAdapterConfiguration createConfiguration(
		...
		return new FileInputAdapterConfiguration(inputFileName,-1,fileFormatterType,-1);
	}
