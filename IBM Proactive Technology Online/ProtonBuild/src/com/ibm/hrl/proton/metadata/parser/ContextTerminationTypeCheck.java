...
class ContextTerminationTypeCheck extends NullCheckAndEnum<ContextTerminationTypeEnum> {


	public ContextTerminationTypeCheck(String key, JSONObject jsonObject, String name,
	...
	@Override
	protected ContextTerminationTypeEnum getEnumInner(String value) throws IllegalArgumentException {
		return ContextTerminationTypeEnum.valueOf(value);
	}
}
