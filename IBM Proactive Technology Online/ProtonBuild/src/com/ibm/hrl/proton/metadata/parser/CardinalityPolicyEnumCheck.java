...
public class CardinalityPolicyEnumCheck extends NullCheckAndEnum<CardinalityPolicyEnum> {

	public CardinalityPolicyEnumCheck(String key, JSONObject jsonObject, String name,
	...
	@Override
	protected CardinalityPolicyEnum getEnumInner(String value) throws IllegalArgumentException {
		return CardinalityPolicyEnum.valueOf(value);
	}
